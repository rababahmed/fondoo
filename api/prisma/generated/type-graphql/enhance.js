...
const actionResolversMap = {
    Restaurant: {
        findUniqueRestaurant: actionResolvers.FindUniqueRestaurantResolver,
        findFirstRestaurant: actionResolvers.FindFirstRestaurantResolver,
        findManyRestaurant: actionResolvers.FindManyRestaurantResolver,
    ...
    ProductCategory: {
        findUniqueProductCategory: actionResolvers.FindUniqueProductCategoryResolver,
        findFirstProductCategory: actionResolvers.FindFirstProductCategoryResolver,
        findManyProductCategory: actionResolvers.FindManyProductCategoryResolver,
    ...
    Product: {
        findUniqueProduct: actionResolvers.FindUniqueProductResolver,
        findFirstProduct: actionResolvers.FindFirstProductResolver,
        findManyProduct: actionResolvers.FindManyProductResolver,
    ...
    Schedule: {
        findUniqueSchedule: actionResolvers.FindUniqueScheduleResolver,
        findFirstSchedule: actionResolvers.FindFirstScheduleResolver,
        findManySchedule: actionResolvers.FindManyScheduleResolver,
    ...
    DeliveryZone: {
        findUniqueDeliveryZone: actionResolvers.FindUniqueDeliveryZoneResolver,
        findFirstDeliveryZone: actionResolvers.FindFirstDeliveryZoneResolver,
        findManyDeliveryZone: actionResolvers.FindManyDeliveryZoneResolver,
    ...
    Customer: {
        findUniqueCustomer: actionResolvers.FindUniqueCustomerResolver,
        findFirstCustomer: actionResolvers.FindFirstCustomerResolver,
        findManyCustomer: actionResolvers.FindManyCustomerResolver,
    ...
    CustomerAddress: {
        findUniqueCustomerAddress: actionResolvers.FindUniqueCustomerAddressResolver,
        findFirstCustomerAddress: actionResolvers.FindFirstCustomerAddressResolver,
        findManyCustomerAddress: actionResolvers.FindManyCustomerAddressResolver,
    ...
    CustomerToken: {
        findUniqueCustomerToken: actionResolvers.FindUniqueCustomerTokenResolver,
        findFirstCustomerToken: actionResolvers.FindFirstCustomerTokenResolver,
        findManyCustomerToken: actionResolvers.FindManyCustomerTokenResolver,
    ...
    User: {
        findUniqueUser: actionResolvers.FindUniqueUserResolver,
        findFirstUser: actionResolvers.FindFirstUserResolver,
        findManyUser: actionResolvers.FindManyUserResolver,
    ...
    UserToken: {
        findUniqueUserToken: actionResolvers.FindUniqueUserTokenResolver,
        findFirstUserToken: actionResolvers.FindFirstUserTokenResolver,
        findManyUserToken: actionResolvers.FindManyUserTokenResolver,
    ...
    Order: {
        findUniqueOrder: actionResolvers.FindUniqueOrderResolver,
        findFirstOrder: actionResolvers.FindFirstOrderResolver,
        findManyOrder: actionResolvers.FindManyOrderResolver,
...
const resolversInfo = {
    Restaurant: ["findUniqueRestaurant", "findFirstRestaurant", "findManyRestaurant", "createRestaurant", "createManyRestaurant", "deleteRestaurant", "updateRestaurant", "deleteManyRestaurant", "updateManyRestaurant", "upsertRestaurant", "aggregateRestaurant", "groupByRestaurant"],
    ProductCategory: ["findUniqueProductCategory", "findFirstProductCategory", "findManyProductCategory", "createProductCategory", "createManyProductCategory", "deleteProductCategory", "updateProductCategory", "deleteManyProductCategory", "updateManyProductCategory", "upsertProductCategory", "aggregateProductCategory", "groupByProductCategory"],
    Product: ["findUniqueProduct", "findFirstProduct", "findManyProduct", "createProduct", "createManyProduct", "deleteProduct", "updateProduct", "deleteManyProduct", "updateManyProduct", "upsertProduct", "aggregateProduct", "groupByProduct"],
    Schedule: ["findUniqueSchedule", "findFirstSchedule", "findManySchedule", "createSchedule", "createManySchedule", "deleteSchedule", "updateSchedule", "deleteManySchedule", "updateManySchedule", "upsertSchedule", "aggregateSchedule", "groupBySchedule"],
    DeliveryZone: ["findUniqueDeliveryZone", "findFirstDeliveryZone", "findManyDeliveryZone", "createDeliveryZone", "createManyDeliveryZone", "deleteDeliveryZone", "updateDeliveryZone", "deleteManyDeliveryZone", "updateManyDeliveryZone", "upsertDeliveryZone", "aggregateDeliveryZone", "groupByDeliveryZone"],
    Customer: ["findUniqueCustomer", "findFirstCustomer", "findManyCustomer", "createCustomer", "createManyCustomer", "deleteCustomer", "updateCustomer", "deleteManyCustomer", "updateManyCustomer", "upsertCustomer", "aggregateCustomer", "groupByCustomer"],
    CustomerAddress: ["findUniqueCustomerAddress", "findFirstCustomerAddress", "findManyCustomerAddress", "createCustomerAddress", "createManyCustomerAddress", "deleteCustomerAddress", "updateCustomerAddress", "deleteManyCustomerAddress", "updateManyCustomerAddress", "upsertCustomerAddress", "aggregateCustomerAddress", "groupByCustomerAddress"],
    CustomerToken: ["findUniqueCustomerToken", "findFirstCustomerToken", "findManyCustomerToken", "createCustomerToken", "createManyCustomerToken", "deleteCustomerToken", "updateCustomerToken", "deleteManyCustomerToken", "updateManyCustomerToken", "upsertCustomerToken", "aggregateCustomerToken", "groupByCustomerToken"],
    User: ["findUniqueUser", "findFirstUser", "findManyUser", "createUser", "createManyUser", "deleteUser", "updateUser", "deleteManyUser", "updateManyUser", "upsertUser", "aggregateUser", "groupByUser"],
    UserToken: ["findUniqueUserToken", "findFirstUserToken", "findManyUserToken", "createUserToken", "createManyUserToken", "deleteUserToken", "updateUserToken", "deleteManyUserToken", "updateManyUserToken", "upsertUserToken", "aggregateUserToken", "groupByUserToken"],
    Order: ["findUniqueOrder", "findFirstOrder", "findManyOrder", "createOrder", "createManyOrder", "deleteOrder", "updateOrder", "deleteManyOrder", "updateManyOrder", "upsertOrder", "aggregateOrder", "groupByOrder"]
};
...
const inputsInfo = {
    ...
    RestaurantUncheckedCreateInput: ["id", "createdAt", "name", "email", "businessPhone", "reservationPhone", "url", "address", "city", "postCode", "country", "currency", "priceRange", "diningStyle", "vat", "serviceCharge", "hasParking", "hasPartyFacilities", "hasKidsZone", "isTakeaway", "isDelivery", "isReservation", "isOrdering", "isAutoAcceptOrder", "isAutoAcceptReservation", "updatedAt", "schedule", "deliveryZones", "customers", "orders", "productCategory", "products", "users"],
    ...
    ProductCategoryUncheckedCreateInput: ["id", "createdAt", "name", "description", "image", "isActive", "isFeatured", "restaurantId", "Product"],
    ProductCategoryUpdateInput: ["id", "createdAt", "name", "description", "image", "isActive", "isFeatured", "restaurants", "Product"],
    ProductCategoryUncheckedUpdateInput: ["id", "createdAt", "name", "description", "image", "isActive", "isFeatured", "restaurantId", "Product"],
    ...
    ProductCategoryUncheckedUpdateManyInput: ["id", "createdAt", "name", "description", "image", "isActive", "isFeatured", "restaurantId"],
    ProductCreateInput: ["id", "createdAt", "name", "description", "image", "price", "spiceLevel", "isPopular", "isActive", "ProductCategory", "Restaurant"],
    ProductUncheckedCreateInput: ["id", "createdAt", "name", "description", "image", "price", "spiceLevel", "isPopular", "isActive", "productCategoryId", "restaurantId"],
    ProductUpdateInput: ["id", "createdAt", "name", "description", "image", "price", "spiceLevel", "isPopular", "isActive", "ProductCategory", "Restaurant"],
    ProductUncheckedUpdateInput: ["id", "createdAt", "name", "description", "image", "price", "spiceLevel", "isPopular", "isActive", "productCategoryId", "restaurantId"],
    ...
    ProductUncheckedUpdateManyInput: ["id", "createdAt", "name", "description", "image", "price", "spiceLevel", "isPopular", "isActive", "productCategoryId", "restaurantId"],
    ScheduleCreateInput: ["createdAt", "openingTime", "closingTime", "minDeliveryAmount", "deliveryTime", "takeawayTime", "Restaurant"],
    ScheduleUncheckedCreateInput: ["id", "createdAt", "openingTime", "closingTime", "minDeliveryAmount", "deliveryTime", "takeawayTime", "restaurantId"],
    ScheduleUpdateInput: ["createdAt", "openingTime", "closingTime", "minDeliveryAmount", "deliveryTime", "takeawayTime", "Restaurant"],
    ScheduleUncheckedUpdateInput: ["id", "createdAt", "openingTime", "closingTime", "minDeliveryAmount", "deliveryTime", "takeawayTime", "restaurantId"],
    ...
    ScheduleUncheckedUpdateManyInput: ["id", "createdAt", "openingTime", "closingTime", "minDeliveryAmount", "deliveryTime", "takeawayTime", "restaurantId"],
    ...
    DeliveryZoneUncheckedCreateInput: ["id", "createdAt", "zoneTitle", "zonePostCode", "deliveryFeeType", "deliveryCharge", "minDeliveryAmount", "minDeliveryRadius", "maxDeliveryRadius", "restaurantId"],
    ...
    DeliveryZoneUncheckedUpdateInput: ["id", "createdAt", "zoneTitle", "zonePostCode", "deliveryFeeType", "deliveryCharge", "minDeliveryAmount", "minDeliveryRadius", "maxDeliveryRadius", "restaurantId"],
    ...
    DeliveryZoneUncheckedUpdateManyInput: ["id", "createdAt", "zoneTitle", "zonePostCode", "deliveryFeeType", "deliveryCharge", "minDeliveryAmount", "minDeliveryRadius", "maxDeliveryRadius", "restaurantId"],
    CustomerCreateInput: ["createdAt", "firstName", "lastName", "email", "password", "phone", "updatedAt", "token", "address", "orders", "Restaurant"],
    CustomerUncheckedCreateInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "restaurantId", "updatedAt", "token", "address", "orders"],
    CustomerUpdateInput: ["createdAt", "firstName", "lastName", "email", "password", "phone", "updatedAt", "token", "address", "orders", "Restaurant"],
    CustomerUncheckedUpdateInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "restaurantId", "updatedAt", "token", "address", "orders"],
    ...
    CustomerUncheckedUpdateManyInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "restaurantId", "updatedAt"],
    CustomerAddressCreateInput: ["createdAt", "streetAddress", "city", "postCode", "country", "Customer", "Order"],
    CustomerAddressUncheckedCreateInput: ["id", "createdAt", "streetAddress", "city", "postCode", "country", "customerId", "Order"],
    CustomerAddressUpdateInput: ["createdAt", "streetAddress", "city", "postCode", "country", "Customer", "Order"],
    CustomerAddressUncheckedUpdateInput: ["id", "createdAt", "streetAddress", "city", "postCode", "country", "customerId", "Order"],
    ...
    CustomerAddressUncheckedUpdateManyInput: ["id", "createdAt", "streetAddress", "city", "postCode", "country", "customerId"],
    CustomerTokenCreateInput: ["token", "createdAt", "updatedAt", "Customer"],
    CustomerTokenUncheckedCreateInput: ["id", "token", "createdAt", "updatedAt", "customerId"],
    CustomerTokenUpdateInput: ["token", "createdAt", "updatedAt", "Customer"],
    CustomerTokenUncheckedUpdateInput: ["id", "token", "createdAt", "updatedAt", "customerId"],
    ...
    CustomerTokenUncheckedUpdateManyInput: ["id", "token", "createdAt", "updatedAt", "customerId"],
    UserCreateInput: ["createdAt", "firstName", "lastName", "email", "password", "phone", "role", "token", "Restaurant", "orders"],
    UserUncheckedCreateInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "role", "restaurantId", "token", "orders"],
    UserUpdateInput: ["createdAt", "firstName", "lastName", "email", "password", "phone", "role", "token", "Restaurant", "orders"],
    UserUncheckedUpdateInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "role", "restaurantId", "token", "orders"],
    ...
    UserUncheckedUpdateManyInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "role", "restaurantId"],
    UserTokenCreateInput: ["token", "provider", "createdAt", "updatedAt", "User"],
    UserTokenUncheckedCreateInput: ["id", "token", "provider", "createdAt", "updatedAt", "userId"],
    UserTokenUpdateInput: ["token", "provider", "createdAt", "updatedAt", "User"],
    UserTokenUncheckedUpdateInput: ["id", "token", "provider", "createdAt", "updatedAt", "userId"],
    ...
    UserTokenUncheckedUpdateManyInput: ["id", "token", "provider", "createdAt", "updatedAt", "userId"],
    ...
    OrderUncheckedCreateInput: ["id", "items", "coupon", "deliveryCharges", "vat", "serviceCharge", "total", "isAccepted", "createdAt", "updatedAt", "userId", "restaurantId", "customerId", "customerAddressId"],
    ...
    OrderUncheckedUpdateInput: ["id", "items", "coupon", "deliveryCharges", "vat", "serviceCharge", "total", "isAccepted", "createdAt", "updatedAt", "userId", "restaurantId", "customerId", "customerAddressId"],
    ...
    OrderUncheckedUpdateManyInput: ["id", "items", "coupon", "deliveryCharges", "vat", "serviceCharge", "total", "isAccepted", "createdAt", "updatedAt", "userId", "restaurantId", "customerId", "customerAddressId"],
    ...
    ScheduleUncheckedCreateNestedManyWithoutRestaurantInput: ["create", "connectOrCreate", "createMany", "connect"],
    DeliveryZoneUncheckedCreateNestedManyWithoutRestaurantInput: ["create", "connectOrCreate", "createMany", "connect"],
    CustomerUncheckedCreateNestedManyWithoutRestaurantInput: ["create", "connectOrCreate", "createMany", "connect"],
    OrderUncheckedCreateNestedManyWithoutRestaurantInput: ["create", "connectOrCreate", "createMany", "connect"],
    ProductCategoryUncheckedCreateNestedManyWithoutRestaurantsInput: ["create", "connectOrCreate", "createMany", "connect"],
    ProductUncheckedCreateNestedManyWithoutRestaurantInput: ["create", "connectOrCreate", "createMany", "connect"],
    UserUncheckedCreateNestedManyWithoutRestaurantInput: ["create", "connectOrCreate", "createMany", "connect"],
    ...
    ScheduleUncheckedUpdateManyWithoutRestaurantInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    DeliveryZoneUncheckedUpdateManyWithoutRestaurantInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    CustomerUncheckedUpdateManyWithoutRestaurantInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    OrderUncheckedUpdateManyWithoutRestaurantInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    ProductCategoryUncheckedUpdateManyWithoutRestaurantsInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    ProductUncheckedUpdateManyWithoutRestaurantInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    UserUncheckedUpdateManyWithoutRestaurantInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    ...
    ProductUncheckedCreateNestedManyWithoutProductCategoryInput: ["create", "connectOrCreate", "createMany", "connect"],
    ...
    ProductUncheckedUpdateManyWithoutProductCategoryInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    ...
    CustomerTokenUncheckedCreateNestedManyWithoutCustomerInput: ["create", "connectOrCreate", "createMany", "connect"],
    CustomerAddressUncheckedCreateNestedManyWithoutCustomerInput: ["create", "connectOrCreate", "createMany", "connect"],
    OrderUncheckedCreateNestedManyWithoutCustomerInput: ["create", "connectOrCreate", "createMany", "connect"],
    ...
    CustomerTokenUncheckedUpdateManyWithoutCustomerInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    CustomerAddressUncheckedUpdateManyWithoutCustomerInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    OrderUncheckedUpdateManyWithoutCustomerInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    ...
    OrderUncheckedCreateNestedManyWithoutCustomerAddressInput: ["create", "connectOrCreate", "createMany", "connect"],
    ...
    OrderUncheckedUpdateManyWithoutCustomerAddressInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    ...
    UserTokenUncheckedCreateNestedManyWithoutUserInput: ["create", "connectOrCreate", "createMany", "connect"],
    OrderUncheckedCreateNestedManyWithoutUserInput: ["create", "connectOrCreate", "createMany", "connect"],
    ...
    UserTokenUncheckedUpdateManyWithoutUserInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    OrderUncheckedUpdateManyWithoutUserInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
    ...
    ScheduleUncheckedCreateWithoutRestaurantInput: ["id", "createdAt", "openingTime", "closingTime", "minDeliveryAmount", "deliveryTime", "takeawayTime"],
    ...
    DeliveryZoneUncheckedCreateWithoutRestaurantInput: ["id", "createdAt", "zoneTitle", "zonePostCode", "deliveryFeeType", "deliveryCharge", "minDeliveryAmount", "minDeliveryRadius", "maxDeliveryRadius"],
    ...
    CustomerUncheckedCreateWithoutRestaurantInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "updatedAt", "token", "address", "orders"],
    ...
    OrderUncheckedCreateWithoutRestaurantInput: ["id", "items", "coupon", "deliveryCharges", "vat", "serviceCharge", "total", "isAccepted", "createdAt", "updatedAt", "userId", "customerId", "customerAddressId"],
    ...
    ProductCategoryUncheckedCreateWithoutRestaurantsInput: ["id", "createdAt", "name", "description", "image", "isActive", "isFeatured", "Product"],
    ...
    ProductUncheckedCreateWithoutRestaurantInput: ["id", "createdAt", "name", "description", "image", "price", "spiceLevel", "isPopular", "isActive", "productCategoryId"],
    ...
    UserUncheckedCreateWithoutRestaurantInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "role", "token", "orders"],
    ...
    RestaurantUncheckedCreateWithoutProductCategoryInput: ["id", "createdAt", "name", "email", "businessPhone", "reservationPhone", "url", "address", "city", "postCode", "country", "currency", "priceRange", "diningStyle", "vat", "serviceCharge", "hasParking", "hasPartyFacilities", "hasKidsZone", "isTakeaway", "isDelivery", "isReservation", "isOrdering", "isAutoAcceptOrder", "isAutoAcceptReservation", "updatedAt", "schedule", "deliveryZones", "customers", "orders", "products", "users"],
    ...
    ProductUncheckedCreateWithoutProductCategoryInput: ["id", "createdAt", "name", "description", "image", "price", "spiceLevel", "isPopular", "isActive", "restaurantId"],
    ...
    RestaurantUncheckedUpdateWithoutProductCategoryInput: ["id", "createdAt", "name", "email", "businessPhone", "reservationPhone", "url", "address", "city", "postCode", "country", "currency", "priceRange", "diningStyle", "vat", "serviceCharge", "hasParking", "hasPartyFacilities", "hasKidsZone", "isTakeaway", "isDelivery", "isReservation", "isOrdering", "isAutoAcceptOrder", "isAutoAcceptReservation", "updatedAt", "schedule", "deliveryZones", "customers", "orders", "products", "users"],
    ...
    ProductCategoryUncheckedCreateWithoutProductInput: ["id", "createdAt", "name", "description", "image", "isActive", "isFeatured", "restaurantId"],
    ...
    RestaurantUncheckedCreateWithoutProductsInput: ["id", "createdAt", "name", "email", "businessPhone", "reservationPhone", "url", "address", "city", "postCode", "country", "currency", "priceRange", "diningStyle", "vat", "serviceCharge", "hasParking", "hasPartyFacilities", "hasKidsZone", "isTakeaway", "isDelivery", "isReservation", "isOrdering", "isAutoAcceptOrder", "isAutoAcceptReservation", "updatedAt", "schedule", "deliveryZones", "customers", "orders", "productCategory", "users"],
    ...
    ProductCategoryUncheckedUpdateWithoutProductInput: ["id", "createdAt", "name", "description", "image", "isActive", "isFeatured", "restaurantId"],
    ...
    RestaurantUncheckedUpdateWithoutScheduleInput: ["id", "createdAt", "name", "email", "businessPhone", "reservationPhone", "url", "address", "city", "postCode", "country", "currency", "priceRange", "diningStyle", "vat", "serviceCharge", "hasParking", "hasPartyFacilities", "hasKidsZone", "isTakeaway", "isDelivery", "isReservation", "isOrdering", "isAutoAcceptOrder", "isAutoAcceptReservation", "updatedAt", "deliveryZones", "customers", "orders", "productCategory", "products", "users"],
    ...
    RestaurantUncheckedCreateWithoutDeliveryZonesInput: ["id", "createdAt", "name", "email", "businessPhone", "reservationPhone", "url", "address", "city", "postCode", "country", "currency", "priceRange", "diningStyle", "vat", "serviceCharge", "hasParking", "hasPartyFacilities", "hasKidsZone", "isTakeaway", "isDelivery", "isReservation", "isOrdering", "isAutoAcceptOrder", "isAutoAcceptReservation", "updatedAt", "schedule", "customers", "orders", "productCategory", "products", "users"],
    ...
    RestaurantUncheckedUpdateWithoutDeliveryZonesInput: ["id", "createdAt", "name", "email", "businessPhone", "reservationPhone", "url", "address", "city", "postCode", "country", "currency", "priceRange", "diningStyle", "vat", "serviceCharge", "hasParking", "hasPartyFacilities", "hasKidsZone", "isTakeaway", "isDelivery", "isReservation", "isOrdering", "isAutoAcceptOrder", "isAutoAcceptReservation", "updatedAt", "schedule", "customers", "orders", "productCategory", "products", "users"],
    CustomerTokenCreateWithoutCustomerInput: ["token", "createdAt", "updatedAt"],
    CustomerTokenUncheckedCreateWithoutCustomerInput: ["id", "token", "createdAt", "updatedAt"],
    ...
    CustomerAddressUncheckedCreateWithoutCustomerInput: ["id", "createdAt", "streetAddress", "city", "postCode", "country", "Order"],
    ...
    OrderUncheckedCreateWithoutCustomerInput: ["id", "items", "coupon", "deliveryCharges", "vat", "serviceCharge", "total", "isAccepted", "createdAt", "updatedAt", "userId", "restaurantId", "customerAddressId"],
    ...
    RestaurantUncheckedUpdateWithoutCustomersInput: ["id", "createdAt", "name", "email", "businessPhone", "reservationPhone", "url", "address", "city", "postCode", "country", "currency", "priceRange", "diningStyle", "vat", "serviceCharge", "hasParking", "hasPartyFacilities", "hasKidsZone", "isTakeaway", "isDelivery", "isReservation", "isOrdering", "isAutoAcceptOrder", "isAutoAcceptReservation", "updatedAt", "schedule", "deliveryZones", "orders", "productCategory", "products", "users"],
    CustomerCreateWithoutAddressInput: ["createdAt", "firstName", "lastName", "email", "password", "phone", "updatedAt", "token", "orders", "Restaurant"],
    CustomerUncheckedCreateWithoutAddressInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "restaurantId", "updatedAt", "token", "orders"],
    ...
    OrderUncheckedCreateWithoutCustomerAddressInput: ["id", "items", "coupon", "deliveryCharges", "vat", "serviceCharge", "total", "isAccepted", "createdAt", "updatedAt", "userId", "restaurantId", "customerId"],
    ...
    CustomerUncheckedUpdateWithoutAddressInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "restaurantId", "updatedAt", "token", "orders"],
    ...
    CustomerUncheckedCreateWithoutTokenInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "restaurantId", "updatedAt", "address", "orders"],
    ...
    CustomerUncheckedUpdateWithoutTokenInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "restaurantId", "updatedAt", "address", "orders"],
    UserTokenCreateWithoutUserInput: ["token", "provider", "createdAt", "updatedAt"],
    UserTokenUncheckedCreateWithoutUserInput: ["id", "token", "provider", "createdAt", "updatedAt"],
    ...
    RestaurantUncheckedCreateWithoutUsersInput: ["id", "createdAt", "name", "email", "businessPhone", "reservationPhone", "url", "address", "city", "postCode", "country", "currency", "priceRange", "diningStyle", "vat", "serviceCharge", "hasParking", "hasPartyFacilities", "hasKidsZone", "isTakeaway", "isDelivery", "isReservation", "isOrdering", "isAutoAcceptOrder", "isAutoAcceptReservation", "updatedAt", "schedule", "deliveryZones", "customers", "orders", "productCategory", "products"],
    ...
    OrderUncheckedCreateWithoutUserInput: ["id", "items", "coupon", "deliveryCharges", "vat", "serviceCharge", "total", "isAccepted", "createdAt", "updatedAt", "restaurantId", "customerId", "customerAddressId"],
    ...
    RestaurantUncheckedUpdateWithoutUsersInput: ["id", "createdAt", "name", "email", "businessPhone", "reservationPhone", "url", "address", "city", "postCode", "country", "currency", "priceRange", "diningStyle", "vat", "serviceCharge", "hasParking", "hasPartyFacilities", "hasKidsZone", "isTakeaway", "isDelivery", "isReservation", "isOrdering", "isAutoAcceptOrder", "isAutoAcceptReservation", "updatedAt", "schedule", "deliveryZones", "customers", "orders", "productCategory", "products"],
    ...
    UserUncheckedCreateWithoutTokenInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "role", "restaurantId", "orders"],
    ...
    UserUncheckedUpdateWithoutTokenInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "role", "restaurantId", "orders"],
    UserCreateWithoutOrdersInput: ["createdAt", "firstName", "lastName", "email", "password", "phone", "role", "token", "Restaurant"],
    UserUncheckedCreateWithoutOrdersInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "role", "restaurantId", "token"],
    ...
    RestaurantUncheckedCreateWithoutOrdersInput: ["id", "createdAt", "name", "email", "businessPhone", "reservationPhone", "url", "address", "city", "postCode", "country", "currency", "priceRange", "diningStyle", "vat", "serviceCharge", "hasParking", "hasPartyFacilities", "hasKidsZone", "isTakeaway", "isDelivery", "isReservation", "isOrdering", "isAutoAcceptOrder", "isAutoAcceptReservation", "updatedAt", "schedule", "deliveryZones", "customers", "productCategory", "products", "users"],
    ...
    CustomerUncheckedCreateWithoutOrdersInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "restaurantId", "updatedAt", "token", "address"],
    ...
    CustomerAddressUncheckedCreateWithoutOrderInput: ["id", "createdAt", "streetAddress", "city", "postCode", "country", "customerId"],
    ...
    UserUncheckedUpdateWithoutOrdersInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "role", "restaurantId", "token"],
    ...
    CustomerUncheckedUpdateWithoutOrdersInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "restaurantId", "updatedAt", "token", "address"],
    ...
    CustomerAddressUncheckedUpdateWithoutOrderInput: ["id", "createdAt", "streetAddress", "city", "postCode", "country", "customerId"],
    ...
    ScheduleUncheckedUpdateWithoutRestaurantInput: ["id", "createdAt", "openingTime", "closingTime", "minDeliveryAmount", "deliveryTime", "takeawayTime"],
    ScheduleUncheckedUpdateManyWithoutScheduleInput: ["id", "createdAt", "openingTime", "closingTime", "minDeliveryAmount", "deliveryTime", "takeawayTime"],
    ...
    DeliveryZoneUncheckedUpdateWithoutRestaurantInput: ["id", "createdAt", "zoneTitle", "zonePostCode", "deliveryFeeType", "deliveryCharge", "minDeliveryAmount", "minDeliveryRadius", "maxDeliveryRadius"],
    DeliveryZoneUncheckedUpdateManyWithoutDeliveryZonesInput: ["id", "createdAt", "zoneTitle", "zonePostCode", "deliveryFeeType", "deliveryCharge", "minDeliveryAmount", "minDeliveryRadius", "maxDeliveryRadius"],
    CustomerUpdateWithoutRestaurantInput: ["createdAt", "firstName", "lastName", "email", "password", "phone", "updatedAt", "token", "address", "orders"],
    CustomerUncheckedUpdateWithoutRestaurantInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "updatedAt", "token", "address", "orders"],
    CustomerUncheckedUpdateManyWithoutCustomersInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "updatedAt"],
    ...
    OrderUncheckedUpdateWithoutRestaurantInput: ["id", "items", "coupon", "deliveryCharges", "vat", "serviceCharge", "total", "isAccepted", "createdAt", "updatedAt", "userId", "customerId", "customerAddressId"],
    OrderUncheckedUpdateManyWithoutOrdersInput: ["id", "items", "coupon", "deliveryCharges", "vat", "serviceCharge", "total", "isAccepted", "createdAt", "updatedAt", "userId", "customerId", "customerAddressId"],
    ProductCategoryUpdateWithoutRestaurantsInput: ["id", "createdAt", "name", "description", "image", "isActive", "isFeatured", "Product"],
    ProductCategoryUncheckedUpdateWithoutRestaurantsInput: ["id", "createdAt", "name", "description", "image", "isActive", "isFeatured", "Product"],
    ProductCategoryUncheckedUpdateManyWithoutProductCategoryInput: ["id", "createdAt", "name", "description", "image", "isActive", "isFeatured"],
    ...
    ProductUncheckedUpdateWithoutRestaurantInput: ["id", "createdAt", "name", "description", "image", "price", "spiceLevel", "isPopular", "isActive", "productCategoryId"],
    ProductUncheckedUpdateManyWithoutProductsInput: ["id", "createdAt", "name", "description", "image", "price", "spiceLevel", "isPopular", "isActive", "productCategoryId"],
    UserUpdateWithoutRestaurantInput: ["createdAt", "firstName", "lastName", "email", "password", "phone", "role", "token", "orders"],
    UserUncheckedUpdateWithoutRestaurantInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "role", "token", "orders"],
    UserUncheckedUpdateManyWithoutUsersInput: ["id", "createdAt", "firstName", "lastName", "email", "password", "phone", "role"],
    ...
    ProductUncheckedUpdateWithoutProductCategoryInput: ["id", "createdAt", "name", "description", "image", "price", "spiceLevel", "isPopular", "isActive", "restaurantId"],
    ProductUncheckedUpdateManyWithoutProductInput: ["id", "createdAt", "name", "description", "image", "price", "spiceLevel", "isPopular", "isActive", "restaurantId"],
    ...
    CustomerTokenUncheckedUpdateWithoutCustomerInput: ["id", "token", "createdAt", "updatedAt"],
    CustomerTokenUncheckedUpdateManyWithoutTokenInput: ["id", "token", "createdAt", "updatedAt"],
    CustomerAddressUpdateWithoutCustomerInput: ["createdAt", "streetAddress", "city", "postCode", "country", "Order"],
    CustomerAddressUncheckedUpdateWithoutCustomerInput: ["id", "createdAt", "streetAddress", "city", "postCode", "country", "Order"],
    CustomerAddressUncheckedUpdateManyWithoutAddressInput: ["id", "createdAt", "streetAddress", "city", "postCode", "country"],
    ...
    OrderUncheckedUpdateWithoutCustomerInput: ["id", "items", "coupon", "deliveryCharges", "vat", "serviceCharge", "total", "isAccepted", "createdAt", "updatedAt", "userId", "restaurantId", "customerAddressId"],
    ...
    OrderUncheckedUpdateWithoutCustomerAddressInput: ["id", "items", "coupon", "deliveryCharges", "vat", "serviceCharge", "total", "isAccepted", "createdAt", "updatedAt", "userId", "restaurantId", "customerId"],
    OrderUncheckedUpdateManyWithoutOrderInput: ["id", "items", "coupon", "deliveryCharges", "vat", "serviceCharge", "total", "isAccepted", "createdAt", "updatedAt", "userId", "restaurantId", "customerId"],
    ...
    UserTokenUncheckedUpdateWithoutUserInput: ["id", "token", "provider", "createdAt", "updatedAt"],
    UserTokenUncheckedUpdateManyWithoutTokenInput: ["id", "token", "provider", "createdAt", "updatedAt"],
    ...
    OrderUncheckedUpdateWithoutUserInput: ["id", "items", "coupon", "deliveryCharges", "vat", "serviceCharge", "total", "isAccepted", "createdAt", "updatedAt", "restaurantId", "customerId", "customerAddressId"]
};
const outputsInfo = {
