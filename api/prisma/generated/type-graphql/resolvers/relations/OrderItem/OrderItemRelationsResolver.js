...
let OrderItemRelationsResolver = class OrderItemRelationsResolver {
    ...
    async Restaurant(orderItem, ctx) {
        return helpers_1.getPrismaFromContext(ctx).orderItem.findUnique({
            where: {
                id: orderItem.id,
            },
...
__decorate([
    ...
    __metadata("design:paramtypes", [OrderItem_1.OrderItem, Object]),
...
__decorate([
    ...
    __metadata("design:paramtypes", [OrderItem_1.OrderItem, Object]),
    __metadata("design:returntype", Promise)
], OrderItemRelationsResolver.prototype, "Restaurant", null);
OrderItemRelationsResolver = __decorate([
