...
const ProductCategoryOrderElementArgs_1 = require("./args/ProductCategoryOrderElementArgs");
...
let ProductCategoryRelationsResolver = class ProductCategoryRelationsResolver {
    ...
    async OrderElement(productCategory, ctx, args) {
        return helpers_1.getPrismaFromContext(ctx).productCategory.findUnique({
            where: {
                id: productCategory.id,
            },
...
__decorate([
    ...
    __param(0, TypeGraphQL.Root()), __param(1, TypeGraphQL.Ctx()), __param(2, TypeGraphQL.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [ProductCategory_1.ProductCategory, Object, ProductCategoryOrderElementArgs_1.ProductCategoryOrderElementArgs]),
    __metadata("design:returntype", Promise)
], ProductCategoryRelationsResolver.prototype, "OrderElement", null);
